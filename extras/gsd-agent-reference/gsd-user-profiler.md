...
<reference>
@${OPK_GSD_CORE_DIR}/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `${OPK_GSD_CORE_DIR}/gsd-core/references/user-profiling.md` to load:
