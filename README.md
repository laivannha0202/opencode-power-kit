...
## Format Validation (Formatting Guard)
...
Nếu bạn dùng model yếu / flash / low-cost (Gemini Flash, Claude Haiku, GPT-4o-mini...),
xem `docs/WEAK_MODEL_GUIDE.md`:

- Core rules an toàn cho model yếu
- Full-stack task pattern
- Anti-patterns cần tránh
- Recommended scope-lite commands

Mọi model đều có thể dùng kit, nhưng model yếu được hướng dẫn riêng để
tránh lỗi phổ biến (edit quá nhiều file, chạy lệnh destructive, prompt quá rộng).
